<script setup>
defineProps({
  variant: { type: String, default: 'primary' }, // primary | ghost | link | onTeal | ghostOnTeal
...
.btn--onTeal:hover { background: transparent; color: var(--cream); }
...
.btn--ghostOnTeal:hover { background: var(--cream); color: var(--ink); border-color: var(--cream); }
